...
### 🟢 Day10: PKRI（知识可信度建模）构建（已完成）
- [x] **PKRI特征构建脚本** (`pkri_feature_builder.py`)
  - 提取21个特征（词表匹配、子标签匹配、密度、置信度）
  - 输出CSV格式特征文件
- [x] **PKRI模型训练脚本** (`pkri_train.py`)
  - 逻辑回归模型训练
  - Platt scaling校准
  - q_PKRI后验生成
- [x] **文档更新**
